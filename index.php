...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $feedbackName = trim($_POST["feedback_name"] ?? "");

    $feedbackRating = trim($_POST["rating"] ?? "");
    ...
    <main>
        ...
        <section class="feedback-section">
            ...
            <div class="feedback-header">
                ...
                <p>
                    Share your thoughts about Group 3 and our team page.
                </p>
                ...
                >
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?php echo htmlspecialchars($feedbackName); ?>"
                            required
                        >
                        ...
                        <div class="rating-options">
                            ...
                            <label class="rating-option">
                                ...
                                <input
                                    ...
                                    name="rating"
                                    value="Excellent"
                                    <?php echo ($feedbackRating === "Excellent") ? "checked" : ""; ?>
                                    required
                                >
                            ...
                            <label class="rating-option">
                                ...
                                <input
                                    ...
                                    name="rating"
                                    value="Good"
                                    <?php echo ($feedbackRating === "Good") ? "checked" : ""; ?>
                                >
                            ...
                            <label class="rating-option">
                                ...
                                <input
                                    ...
                                    name="rating"
                                    value="Average"
                                    <?php echo ($feedbackRating === "Average") ? "checked" : ""; ?>
                                >
                            ...
                            <label class="rating-option">
                                ...
                                <input
                                    ...
                                    <?php echo ($feedbackRating === "Needs Improvement") ? "checked" : ""; ?>
                                >
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            required
                        ><?php echo htmlspecialchars($feedbackMessage); ?></textarea>
                    ...
                    <div class="success-message">
                        ...
                        <div>
                            ...
                            <strong>
                                ...
                                Thank you,
                                <?php echo htmlspecialchars($feedbackName); ?>!
